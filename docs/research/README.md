...
| 6 | [`06_route_b_exhaustive.md`](06_route_b_exhaustive.md) | Every known rank-2 mechanism, tested. A **First-Derivative No-Go Lemma** kills all point constructions (Heegner, twists, Stark–Heegner/Darmon); experiment RB1 finds 43/43 Heegner points torsion on `389a1`/`5077a1`, with the control recovering Gross–Zagier (`L_alg = 2k²`) exactly. The survivors are per-prime Selmer-class machines, and the problem reduces to missing theorems MT1–MT4. | 1, 2, 3 |
